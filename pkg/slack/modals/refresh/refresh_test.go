...
func TestView(t *testing.T) {
	...
	assert.Equal(t, "Refresh the Status", view.Title.Text)
	...
	assert.Contains(t, block.Text.Text, "failed")
	assert.Contains(t, block.Text.Text, "retry")
}
...
func TestPrepareNextStepView(t *testing.T) {
	...
	assert.Contains(t, block.Text.Text, "do not close")
}
...
func TestIdentifierConstant(t *testing.T) {
	assert.Equal(t, "refresh", identifier)
}

func TestTitleConstant(t *testing.T) {
	assert.Equal(t, "Refresh the Status", title)
}
